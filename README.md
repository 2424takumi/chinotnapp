...
小じゃみチントン（三味線）の生産実績を記録・管理するWebアプリケーション。

## 📋 重要なドキュメント

- **[包括的システムレビュー報告書](./COMPREHENSIVE_REVIEW_REPORT.md)** - システム全体の評価と改善提案
- **[実装ガイド](./IMPLEMENTATION_GUIDE.md)** - 優先順位付き改善タスクの具体的な手順

> ⚠️ **セキュリティ警告**: 現在、重大な脆弱性が存在します。詳細は上記レポートを参照してください。
