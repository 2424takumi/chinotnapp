...
export type VariantAttributeAssignment =
  Database['public']['Tables']['variant_attribute_assignments']['Row'];
export type OperationVariantAttribute =
  Database['public']['Tables']['operation_variant_attributes']['Row'];
...
export type InventoryAdjustmentAttribute =
  Database['public']['Tables']['inventory_adjustment_attributes']['Row'];
...
export type VariantAttributeValueInsert =
  Database['public']['Tables']['variant_attribute_values']['Insert'];
export type VariantAttributeValueUpdate =
  Database['public']['Tables']['variant_attribute_values']['Update'];
...
export type VariantAttributeAssignmentInsert =
  Database['public']['Tables']['variant_attribute_assignments']['Insert'];
export type VariantAttributeAssignmentUpdate =
  Database['public']['Tables']['variant_attribute_assignments']['Update'];
export type OperationVariantAttributeInsert =
  Database['public']['Tables']['operation_variant_attributes']['Insert'];
export type OperationVariantAttributeUpdate =
  Database['public']['Tables']['operation_variant_attributes']['Update'];
...
export type WorkSessionAttributeInsert =
  Database['public']['Tables']['work_session_attributes']['Insert'];
export type WorkSessionAttributeUpdate =
  Database['public']['Tables']['work_session_attributes']['Update'];
...
export type InventoryAdjustmentAttributeInsert =
  Database['public']['Tables']['inventory_adjustment_attributes']['Insert'];
export type InventoryAdjustmentAttributeUpdate =
  Database['public']['Tables']['inventory_adjustment_attributes']['Update'];
export type ProcessConsumptionInsert =
  Database['public']['Tables']['process_consumption']['Insert'];
export type ProcessConsumptionUpdate =
  Database['public']['Tables']['process_consumption']['Update'];
